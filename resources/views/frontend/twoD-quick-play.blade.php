...
<div class="row">
  ...
  <div class="row mt-2 p-3">
    <div class="col-md-12">
        ...
        <div class="mt-2">
            <div class="">
                <a href="#" class="btn btn-info btn-sm">မမ</a>
                <a href="#" class="btn btn-warning btn-sm">စုံစုံ</a>
                <a href="#" class="btn btn-primary btn-sm">မမ အပူး</a>
                <a href="#" class="btn btn-warning btn-sm">စုံစုံ အပူး</a>
            </div>
        </div>
    </div>
</div>
